		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						...
						<div class="info">
							...
							<small>@<?php echo strtolower($username)." (".$this->session->userdata('tahun').")"; ?></small>
						</div>
					</li>
				</ul>
				<!-- end sidebar user -->
				...
				<ul class="nav">
                    ...
                    <li class="has-sub <?php if($menu=='harmonisasi'
                        OR ($menu=='harmonisasi' AND $sub_menu=='v')
                        OR ($menu=='folder_data_dukung' AND $sub_menu=='v')
                        OR ($menu=='data_dukung' AND $sub_menu=='v')
                        OR ($menu=='rpd' AND $sub_menu=='v')
                        OR ($menu=='ankabut' AND $sub_menu=='v')
                        OR ($menu=='harmonisasi' AND $sub_menu=='v')){echo " active";} ?>">
                    ...
                    <li class="has-sub <?php foreach ($dt_tbl_zona->result() as $id=>$val) {
                        if($menu=='pemda_raperkada' AND $sub_menu=='draft' AND $sub_menu3==$val->nama_zona){
                            echo "active";
                        }
                    } ?> ">
                        <a href="javascript:;">
                            <b class="caret pull-right"></b>
                            <i class="fa fa-pencil-square bg-gray"></i>
                            <!--ASLII-->
                            <span>Draft Raperkada </span>
                        </a>
                        <!--ini dia sidebar menu-->
                        <ul class="sub-menu">
                            ...
                            foreach ($dt_tbl_zona->result() as $id=>$val){ ?>
                                <li <?php
                                /*utk tidak menampilkan beberapa nama zona yg tdk perlu pada tbl_zona*/
                                if ($val->nama_zona=="superadmin") { ?> hidden <?php }
                                else if($val->nama_zona=="kasub_perancang") { ?> hidden <?php }
                                else if($val->nama_zona=="perancang"){ ?> hidden <?php } ?>
                                    <?php if(($menu=='pemda_raperkada' and $sub_menu=='draft' and $sub_menu3==$val->nama_zona)
                                        or ($menu=='pemda_raperkada' and $sub_menu=='draft' and $sub_menu3==$val->nama_zona))
                                    { echo " class='active'"; } ?>
                                    <?php if($this->session->userdata('nama_zona')==$val->nama_zona){?> class="" <?php }
                                    else if ($this->session->userdata('nama_zona')=='superadmin') { ?> class=""<?php }
                                    else if($this->session->userdata('nama_zona')=='kasub_perancang') { ?> class="" <?php }
                                    else { ?> class="hidden" <?php } ?> >
                                    <a href="pemda_raperkada/draft/<?= $val->nama_zona; ?>" >
                                        ...
                                        if($this->session->userdata('level')=="perancang"){
                                            ...
                                            $get_pengajuan_baru = $this->db->query("select * from tbl_draft 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$belum_diproses') 
                                                and id_perancang='$perancang_id' 
                                                and jenis_dokumen='$raperkada' 
                                                order by id_draft_permohonan DESC");

                                            $get_sedang_diproses = $this->db->query("select * from tbl_draft 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$sedang_diproses') 
                                                and id_perancang='$perancang_id' 
                                                and jenis_dokumen='$raperkada' 
                                                order by id_draft_permohonan DESC");

                                            $get_sudah_selesai = $this->db->query("select * from tbl_draft 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$selesai') 
                                                and id_perancang='$perancang_id' 
                                                and jenis_dokumen='$raperkada' 
                                                order by id_draft_permohonan DESC");
                                            if($get_pengajuan_baru->num_rows()>0){
                                                ?>
                                                <label for="label" class="label" style="background-color: red">
                                                    <?php echo $get_pengajuan_baru->num_rows();?>
                                                </label>
                                                <?php
                                            }

                                            if($get_sedang_diproses->num_rows()>0){
                                                ?>
                                                <label for="label" class="label" style="background-color: black">
                                                    <?php echo $get_sedang_diproses->num_rows();?>
                                                </label>
                                                <?php
                                            }

                                            if($get_sudah_selesai->num_rows()>0){
                                                ?>
                                                <label for="label" class="label" style="background-color: green">
                                                    <?php echo $get_sudah_selesai->num_rows();?>
                                                </label>
                                                <?php
                                            }


                                        } else if(($this->session->userdata('level')=="kasub_perancang")
                                            or ($this->session->userdata('level')=="superadmin")
                                            or ($this->session->userdata('level')=="pemda") ){
                                            $get_pengajuan_baru = $this->db->query("select * from tbl_draft 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$belum_diproses') 
                    ...
                    <li class="has-sub <?php foreach ($dt_tbl_zona->result() as $id=>$val) {
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php
                                $dt_tbl_zona = $this->db->get("tbl_zona");
                                foreach ($dt_tbl_zona->result() as $id=>$val){ ?>
                                    <li <?php if ($val->nama_zona=="superadmin"){?> hidden <?php }
                                    else if($val->nama_zona=="kasub_perancang"){?> hidden <?php }
                                    else if($val->nama_zona=="perancang"){ ?> hidden <?php } ?>
                                    <?php if(($menu=='pemda' and $sub_menu=='draft' and $sub_menu3==$val->nama_zona)
                                        or ($menu=='pemda' and $sub_menu=='draft' and $sub_menu3==$val->nama_zona))
                                    { echo " class='active'"; } ?>
                                        <?php if($_SESSION['nama_zona']==$val->nama_zona){?> class="" <?php }
                                        else if ($_SESSION['nama_zona']=='superadmin') { ?> class=""<?php }
                                        else if($_SESSION['nama_zona']=='kasub_perancang') { ?> class="" <?php }
                                        else { ?> class="hidden" <?php } ?> >
                                        <a href="pemda/draft/<?= $val->nama_zona; ?>" >
                                            ...
                                            if($this->session->userdata('level')=="perancang"){
                                                ...
                                                $this->session->userdata('level')=="superadmin" || $this->session->userdata('level')=="pemda" ){
                                                $get_pengajuan_baru = $this->db->query("select * from tbl_draft 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$belum_diproses') 
                                                and jenis_dokumen='$raperda' order by id_draft_permohonan DESC");
                    ...
                    ?>
                    <li class="has-sub <?php foreach ($dt_tbl_zona->result() as $id=>$val) {
                        if(($menu=='hasilharmonisasi' AND $sub_menu=='hasil' AND $sub_menu3==$val->nama_zona)
                            or ($menu=='hasilharmonisasi' AND $sub_menu=='hasil' AND $this->uri->segment(5)==$val->nama_zona)){
                            echo "active";
                        }
                    } ?> ">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li hidden <?php if(($menu=='hasilharmonisasi' and $sub_menu=='hasil' and $sub_menu3=='draft_pemprov_ntb') or ($menu=='pemda' and $sub_menu=='v2' and $sub_menu3=='draft_pemprov_ntb')){ echo " class='active'"; } ?>>
                                <a href="hasilharmonisasi/hasil/draft_pemprov_ntb.html">
                            ...
                            <?php
                                ...
                                foreach ($dt_tbl_zona->result() as $id=>$val){ ?>
                                    ...
                                    <?php if(($menu=='hasilharmonisasi' and $sub_menu=='hasil' and $sub_menu3==$val->nama_zona)
                                        or ($menu=='hasilharmonisasi' and $sub_menu=='hasil' and  $this->uri->segment(5)==$val->nama_zona))
                                    { echo " class='active'"; } ?>
                                        <?php if($_SESSION['nama_zona']==$val->nama_zona){?> class="" <?php }
                                        else if ($_SESSION['nama_zona']=='superadmin') { ?> class=""<?php }
                                        ...
                                        <a href="hasilharmonisasi/hasil/<?= $val->nama_zona; ?>" >
                                            <i class="fa fa-file-text"></i> <span><?= $val->nama_panjang;?></span>
                                            <?php
                                            $belum_diproses = "belum_diproses";
                                            $sedang_diproses = "sedang_diproses";
                                            ...
                                            if($this->session->userdata('level')=="perancang"){
                                                $perancang_id = $this->session->userdata('id_user');
                                                $get_pengajuan_baru = $this->db->query("select * from tbl_berita 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$belum_diproses') 
                                                and id_perancang='$perancang_id' 
                                                order by id_berita DESC");

                                                $get_sedang_diproses = $this->db->query("select * from tbl_berita 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$sedang_diproses') 
                                                and id_perancang='$perancang_id' 
                                                order by id_berita DESC");

                                                $get_sudah_selesai = $this->db->query("select * from tbl_berita 
                                                where left(tgl_input,4)=".$this->session->userdata('tahun')." 
                                                and zona_dokumen='$val->nama_zona' and status in ('$selesai') 
                                                and id_perancang='$perancang_id' 
                                                order by id_berita DESC");

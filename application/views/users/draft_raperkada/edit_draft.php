                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="background-color: ">
                                <label class="col-lg-11" style="background-color:">Surat Permohonan</label>
                                <br>
                            ...
                            <div class="form-group" style="background-color: ">
                                <label class="col-lg-11" style="background-color:">Surat Naskah Akademik/Penjelasan/Keterangan</label>
                                <br>
                                <div class="col-lg-12 <?php if ($status=="selesai") { ?> hidden <?php } ?>">
                                    <input id="naskah_akademik_dll_edit"
                                           type="file"
                                           value=""
                                           onchange="checkSelectedFileDocOnly_edit(id)"
                                           name="naskah_akademik_dll_edit"
                                           class="form-control" <?php if($edit_draft->row()->naskah_akademik_dll == null || $edit_draft->row()->naskah_akademik_dll =="null" || $edit_draft->row()->naskah_akademik_dll ==""){ ?>
                                        required
                                    <?php } ?> >
                            ...
                            <!--sinicuk-->
                            <div class="form-group" style="background-color: ">
                                <label class="col-lg-11" style="background-color:">Rancangan Perkada</label>
                                <br>
                                <div class="col-lg-12 <?php if ($status=="selesai") { ?> hidden <?php } ?>">
                                    <!--sinicuk-->
                                    <input id="rancangan_perkada_edit"
                                           type="file"
                                           value=""
                                           onchange="checkFileExtension_edit(id)"
                                           name="rancangan_perkada_edit"
                                           class="form-control" >
                                    <small class="lh-1" style="color: red"><i>.pdf .doc .docx</i></small>
                                </div>
                                <div class="col-lg-12">
                                    <li class="col-lg-12" style="display: flex ; background-color:  "
                                        id="">
                                        <div class="form-group col-lg-12 m-b-1" style="justify-content: space-between; overflow: auto">
                                            <a style="text-decoration: none; overflow: hidden" href="<?php echo base_url($edit_draft->row()->rancangan_perkada);?>" target="_blank">
                                                <!--                                                <i class="fa fa-check-square" style=" "></i>-->
                                                <?= explode('/',$edit_draft->row()->rancangan_perkada)[2];?>
                            ...
                            <!--sinicuk other-->
                            <div class="form-group" style="background-color: ">
                                <label class="col-lg-11" style="background-color:">Draft Raperkada</label>
                                <br>
                                <div class="col-lg-12 <?php if ($status=="selesai") { ?> hidden <?php } ?>">
                                    <!--sinicuk-->
...
<!--                                                <i class="fa fa-check-square m-l-0" style="margin-right: 10px"></i>-->
                            ...
                            <div class="text-right ">
                                <a href="pemda_raperkada/draft/<?= $edit_draft->row()->zona_dokumen;?>"

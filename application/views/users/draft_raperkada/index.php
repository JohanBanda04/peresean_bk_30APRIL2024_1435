                    ...
                    if($date_publish < $date){
                        ...
                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html"
                           class="btn btn-primary">
                            <!--ASLII-->
                            <i class="fa fa-plus-circle"></i> Tambah Dokumen Draft Raperkada </a>
                        <?php
                    }
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        if ($_SESSION['level'] != "perancang") { ?>
                                            <!--ASLIII-->
                                            <a title="Edited By Pemda "
                                               href="pemda_raperkada/draft/<?= $link3; ?>/ce/<?= hashids_encrypt($baris->id_draft_permohonan); ?>"
                                                <?php if ($baris->nama_perancang != "") {
                                                    if ($_SESSION['level'] == "superadmin") { ?>

        ...
        <div class="panel panel-inverse">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div hidden <?php if ($_SESSION['nama_zona'] == 'pemprov_ntb') { ?> class="col-md-6" <?php } else if ($_SESSION['nama_zona'] == 'perancang') { ?> class="col-md-3" <?php } else { ?> class="col-md-3 hidden" <?php } ?> >
                        <a href="harmonisasi/v/pemprov_ntb.html" style="text-decoration: none">
                            <div class="widget widget-stats bg-gradient-purple text-inverse">
                                ...
                                <!--ASLIII-->
                                <div class="stats-desc">Total Dokumen Harmonisassi</div>
                            </div>
                        </a>
                    ...
                    <div hidden <?php if ($_SESSION['nama_zona'] == 'pemprov_ntb') { ?> class="col-md-6" <?php } else if ($_SESSION['nama_zona'] == 'superadmin') { ?> class="col-md-3 hidden"<?php } else { ?> class="col-md-3 hidden" <?php } ?> >
                        <a href="pemda/draft/pemprov_ntb.html" style="text-decoration: none">
                            <div class="widget widget-stats bg-gradient-dark-blue-light text-inverse">
                                ...
                                <!--ASLIII-->
                                <div class="stats-desc">Total Dokumen Draft Raperdaaaa</div>
                            </div>
                        </a>
                        ...
                        if ($zone->nama_zona != "superadmin" and $zone->nama_zona != "kasub_perancang" and $zone->nama_zona != "perancang") {
                            ...
                            if ($this->session->userdata('level') == "pemda") {
                                if ($this->session->userdata('nama_zona') == $zone->nama_zona) { ?>
                                    ...
                                    <div class="col-md-4">
                                        <a href="pemda_raperkada/draft/<?= $zone->nama_zona ?>" style="text-decoration: none; ">
                                            <div class="widget widget-stats bg-gradient-blue-dark text-inverse">
                                                <div class="stats-icon stats-icon-lg stats-icon-square">
                                                    <i class="fa fa-paper-plane" aria-hidden="true"></i>
                                                </div>
...
<script>
    ...
    //console.log("totalcuk : " + total);

    pemda_id.forEach(myFunction);

    function myFunction(value, key) {
        console.log("valuenyas:"+value);
